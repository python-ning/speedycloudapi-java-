...
private String generateAuthorization(String method, String path, String dateStr) throws NoSuchAlgorithmException, InvalidKeyException {
...
protected Map<String, String> GenerateRequestHeaders(String method, String path) throws Exception {
...
protected HttpURLConnection GetConnection(String method, String targetUrl) throws Exception {
URL url = new URL(targetUrl);
HttpURLConnection conn = (HttpURLConnection)url.openConnection();
conn.setRequestMethod(method.toUpperCase());
Map<String, String> baseHeaders = this.GenerateRequestHeaders(method, url.getPath());
...
public String Post(String targetUrl, Map<String, String> params) throws Exception {
